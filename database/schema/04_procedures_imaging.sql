...
CREATE TABLE medical_procedures (
    ...
    -- Anesthesia
    anesthesia_type VARCHAR(100), -- Local, General, Sedation, etc.
    ...
    outcome VARCHAR(100), -- Successful, Complicated, etc.
...
CREATE TABLE imaging_studies (
    ...
    technique TEXT,
    image_count INTEGER,
    radiation_dose VARCHAR(100), -- For CT, X-Ray studies
...
CREATE TABLE clinical_documents (
    ...
    -- Document Details
    document_type VARCHAR(100) NOT NULL, -- Progress Note, Discharge Summary, Consultation, etc.
    document_title VARCHAR(200),
    document_category VARCHAR(100), -- Clinical, Administrative, Legal, etc.
...
CREATE TABLE appointments (
    ...
    -- Appointment Details
    appointment_type VARCHAR(100) NOT NULL, -- Office Visit, Follow-up, Procedure, etc.
