...
CREATE TABLE blood_glucose_readings (
    ...
    -- Method and Device
    measurement_method VARCHAR(50), -- Glucometer, CGM, Lab
...
CREATE TABLE cgm_readings (
    ...
    -- Device Information
    device_type VARCHAR(100) NOT NULL, -- Dexcom G6, FreeStyle Libre, etc.
...
CREATE TABLE insulin_administrations (
    ...
    insulin_type VARCHAR(100) NOT NULL, -- Rapid-acting, Long-acting, etc.
    insulin_brand VARCHAR(100), -- Humalog, Lantus, etc.
    ...
    -- Method
    delivery_method VARCHAR(50), -- Syringe, Pen, Pump
...
CREATE TABLE carb_intake (
    ...
    -- Method
    carb_counting_method VARCHAR(50), -- Estimated, Measured, App-calculated
...
CREATE TABLE diabetes_lab_results (
    ...
    test_type VARCHAR(100) NOT NULL, -- HbA1c, Fructosamine, GAD, C-peptide, etc.
    ...
    -- Ketones
    urine_ketones VARCHAR(20), -- Negative, Trace, Small, Moderate, Large
    ...
    glucose_target_range VARCHAR(50), -- "80-130 mg/dL"
...
CREATE TABLE diabetes_complications (
    ...
    complication_type VARCHAR(100) NOT NULL, -- Retinopathy, Nephropathy, Neuropathy, etc.
    complication_category VARCHAR(50), -- Microvascular, Macrovascular, Acute
    ...
    -- Neuropathy
    neuropathy_type VARCHAR(50), -- Peripheral, Autonomic, Focal
    ...
    -- Monitoring
    monitoring_frequency VARCHAR(50), -- Every 3 months, Annually, etc.
...
CREATE TABLE diabetes_education (
    ...
    session_type VARCHAR(100), -- Individual, Group, Online, etc.
